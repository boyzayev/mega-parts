            ...
            <div className="border-[1px] border-[#BDC1C8] my-5 w-full lg:w-2/3">
                <div className="flex">
                    <div className="w-1/3 flex flex-col gap-3 border-r-[1px] border-[#BDC1C8] text-[#505050] bg-[#EFF2F4]">
                        <div className="border-b-[1px] border-[#BDC1C8] pl-2">Model</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-2">Style</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-2">Size</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-2">Certificate</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-2">Memory</div>
                    </div>
                    <div className="w-2/3 flex flex-col gap-3 text-[#505050]">
                        <div className="border-b-[1px] border-[#BDC1C8] pl-3">#8786867</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-3">Classic style</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-3">ISO-898921212</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-3">34mm x 450mm x 19mm</div>
                        <div className="border-b-[1px] border-[#BDC1C8] pl-3">36GB RAM</div>
                    </div>
                </div>
            </div>
