...
export default function Login() {
    ...
    return (
        <div className="p-9 px-20">
            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAP0AAAAQCAMAAADqMYmSAAABWVBMVEUAAAACFGQEFWUCE2UEGGcCFGQHGGUCFGQFFmYCFGQEF2Ux
            ...
            <div className="flex justify-between items-center">
                <div className='flex-col flex gap-5'>
                    ...
                    <div className="">
                        <h1>Already have an accunt? <span onClick={handleClick} className="text-blue-500 cursor-pointer">Register</span></h1>
                    </div>
                </div>
